                ...
                <div className="flex flex-wrap gap-2 items-center">
                  ...
                  {message.sources.map((url, idx) => {
                    try {
                      ...
                      let displayTitle = pathParts[pathParts.length - 1] || "Source Document";
                      if (urlObj.hash) {
                      ...
                      */
                      ...
                      if (url.includes("greenbook-manual-full.pdf")) {
                        finalUrl = `https://www.pge.com/assets/pge/docs/account/service-requests/greenbook-manual-full.pdf${hashStr}`;
